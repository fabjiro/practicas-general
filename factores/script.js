...
let factores = [
    { nombre: 'Riesgo minimo', tipo: '1' },
    { nombre: 'Riesgo medio', tipo: '2' },
    { nombre: 'Riesgo alto', tipo: '3' }
];


function renderTabla() {
    let tbody = '';
    factores.forEach((n, i) => {
        tbody += `<tr>
